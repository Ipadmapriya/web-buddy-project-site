...
export const LoginForm = () => {
  ...
  return (
    <form onSubmit={handleLogin} className="space-y-6 p-8 bg-white rounded-xl shadow-lg border border-indigo-100 relative overflow-hidden">
      ...
      <div className="relative">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <Input
                ...
                required
              />
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-50 to-purple-50 opacity-0 group-hover:opacity-10 rounded-md transition-opacity duration-300 pointer-events-none" />
            </div>
          </div>
        ...
        <Button 
          type="submit" 
          className="w-full mt-8 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium py-2 rounded-lg transition-all duration-300 hover:shadow-lg transform hover:scale-[1.01] active:scale-[0.99]" 
          disabled={isLoading}
        >
